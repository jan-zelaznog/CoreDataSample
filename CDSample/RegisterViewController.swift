...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btnRegistra.bottomAnchor.constraint(equalTo:view.bottomAnchor, constant:-90).isActive = true
    ...
    @objc func btnRegistraTouch() {
        ...
        // crear una copia de la clase NSManagedObject "Persona"
        // esto debería de funcionar, pero... let persona=Persona()
    ...
    func buildUX() {
        ...
        self.scrollView = UIScrollView(frame:CGRect(x:0.0, y:40.0, width:Utils.SCREEN_WIDTH, height:Utils.SCREEN_HEIGHT - 190)) // NO!!
